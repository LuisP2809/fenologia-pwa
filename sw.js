...
const ASSETS=[
  ...
  versioned('./app-admin.js'),versioned('./app-security.js'),versioned('./app-workflow-patches.js'),versioned('./app-export-filters.js'),
  ...
  versioned('./app-evaluator-navigation.js'),versioned('./app-evaluation-flow.js'),versioned('./app-release.js'),
