...
if (!index.includes('app-updater-0.20.0.js')) throw new Error('index.html no carga el puente de recuperación de caché anterior al bootstrap.');
if (!worker.includes('app-updater-0.20.0.js')) throw new Error('El service worker no conserva el puente de recuperación de caché.');
