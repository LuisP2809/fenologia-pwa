...
0.18.0 reinicia únicamente el acceso: retira usuarios, sesiones y tokens locales anteriores, pero conserva evaluaciones e IndexedDB. Los perfiles JSON anteriores dejan de ser compatibles porque fueron reemplazados por activación QR/código.
